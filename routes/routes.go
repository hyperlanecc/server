...
import (
	"hyperlane/controllers"
	"hyperlane/middlewares"
...
func SetupRouter(r *gin.Engine) {
	...
	api := r.Group("/api")
	{
		api.GET("/v1/auth/callback", controllers.HandleOAuthCallback)
		...
		api.GET("/v1/stats", controllers.StatsOverview)
	}
}
